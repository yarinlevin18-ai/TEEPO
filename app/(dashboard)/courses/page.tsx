...
/**
 * /courses — DriveOrganize tree (v2 cream redesign).
 *
 ...
 * (4-level tree: teepo → degree → year → semester) with SVG-painted
 ...
 * this page just renders the tree. Empty-state routing (no degrees yet
 * → /credits) is handled inside the DriveOrganize component itself.
 */

import DriveOrganize from '@/components/drive/DriveOrganize'
